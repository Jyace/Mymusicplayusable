	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		seekBar1.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onStopTrackingTouch(SeekBar seekBar) {
				...
				Intent intent=new Intent("com.example.administrator.mymusicplay.cn.com.karl.seekBar");
		...
		IntentFilter filter=new IntentFilter("com.example.administrator.mymusicplay.cn.com.karl.completion");
